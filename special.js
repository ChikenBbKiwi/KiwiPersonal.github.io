...
while (startDate <= endDate) {
    ...
    if (startDate.toDateString() === endDate.toDateString()) {
        ...
        dateElement.className += ' date-today explode'; // Added 'explode' class
...
// Function to show the gold text
function showGoldText() {
    document.getElementById('gold-text').classList.remove('hidden');
}

// Show the gold text after 5 seconds
setTimeout(showGoldText, 5000);
